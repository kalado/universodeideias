            ...
            <div id="bgwrap">
                <div id="primary_left">
                    ...
                    <div id="menu"> <!-- navigation menu -->
                        <ul>
                            <li class="current"><a href="#" class="dashboard"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/trigger/adm/icons/small_icons_3/dashboard.png" alt=""/><span class="current">Lista de Ideias</span></a></li>
